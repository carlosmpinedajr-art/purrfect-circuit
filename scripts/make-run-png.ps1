...
$input = Join-Path $PSScriptRoot "..\sunny-run-sprites-new.jpg"
$tmp = Join-Path $PSScriptRoot "..\sunny-run-sprites-tmp.png"
$outPng = Join-Path $PSScriptRoot "..\sunny-run-sprites.png"
